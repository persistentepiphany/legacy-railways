...
class ChangeRequest:
    ...
    Two kinds:
      - 'add_railcard': synthetic railcard discount (the original demo).
    ...
    discount_pct: float                   # strict 0 < x < 1 (raise_price: increase fraction)
    ...
    def __post_init__(self) -> None:
        ...
        if self.kind not in ("add_railcard", "raise_price"):
